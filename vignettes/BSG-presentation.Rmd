...
max_date_cutoff <- as.Date('2016-10-31')
```
...
```{r, echo=FALSE, fig.height=5, fig.width=7, cache=TRUE}
clahrcnwlhf::plot_linking_venn(episodes = emergency_adms[which(emergency_adms$Heart.Failure.Episode == TRUE),], linked_bundles = linked_bundle_data, linked_nicor = linked_nicor_data)
```
