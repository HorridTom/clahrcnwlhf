...
```{r popnchars, echo=FALSE, results='asis', cache=TRUE, include=FALSE}
pop_summary <- list(
  "Age" = list(
...
```{r pop-table, results='asis', message='false', include=FALSE}
...
```{r age, echo=FALSE, results='asis', fig.height=5, fig.width=7, cache=TRUE, include=FALSE}
...
```{r ward, echo=FALSE, results='asis', fig.height=5, fig.width=7, cache=TRUE, include=FALSE}
...
```{r spchars, echo=FALSE, results='asis', cache=TRUE, include=FALSE}
...
```{r age-sp, echo=FALSE, results='asis', fig.height=5, fig.width=7, cache=TRUE, include=FALSE}
...
```{r ward-sp, echo=FALSE, results='asis', fig.height=5, fig.width=7, cache=TRUE, include=FALSE}
...
```{r bundles-month, echo=FALSE, results='asis', fig.height=5, fig.width=7, cache=TRUE, include=FALSE}
...
```{r bundles-compliance, echo=FALSE, results='asis', fig.height=5, fig.width=7, cache=TRUE, include=FALSE}
...
```{r readms-chart-7hf, echo=FALSE, results='asis', fig.height=4, fig.width=6, cache=TRUE, include=FALSE}
HF_spells %>% mutate(yearMonth = floor_date(CSPDischargeTime, 'month')) %>%
  filter(HF.any.code == TRUE, yearMonth >= as.Date("2014-04-01"), yearMonth <= as.Date("2017-06-30")) %>%
  group_by(yearMonth, StartWardSite) %>%
...
```{r readms-chart-30hf, echo=FALSE, results='asis', fig.height=4, fig.width=6, cache=TRUE, include=FALSE}
HF_spells %>% mutate(yearMonth = floor_date(CSPDischargeTime, 'month')) %>%
  filter(HF.any.code == TRUE, yearMonth >= as.Date("2014-04-01"), yearMonth <= as.Date("2017-05-30")) %>%
  group_by(yearMonth, StartWardSite) %>%
...
```{r readms-chart-90hf, echo=FALSE, results='asis', fig.height=4, fig.width=6, cache=TRUE, include=FALSE}
HF_spells %>% mutate(yearMonth = floor_date(CSPDischargeTime, 'month')) %>%
  filter(HF.any.code == TRUE, yearMonth >= as.Date("2014-04-01"), yearMonth <= as.Date("2017-03-30")) %>%
  group_by(yearMonth, StartWardSite) %>%
