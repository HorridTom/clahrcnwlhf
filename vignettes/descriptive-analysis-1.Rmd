...
Table1 <- descr::CrossTable(emergency_spells$Heart.Failure.Episode, emergency_spells$period.date, expected = FALSE, prop.r = FALSE, prop.t = FALSE, prop.chisq = TRUE, chisq = TRUE)
