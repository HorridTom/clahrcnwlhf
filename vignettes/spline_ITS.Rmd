...
# Intervention Site Outcome Analysis

## 7-day all cause readmission rate, no control
...
broom.mixed::tidy(hf_read7_all_nc_model_glmer_spline,
                  conf.int=TRUE,
                  conf.method=conf.method,
                  exponentiate=TRUE,
                  effects="fixed") %>%
  mutate(term = if_else(str_detect(term, "splines2"), paste0("Spline", str_sub(term, str_length(term))), term)) %>% 
...
results <- results %>% mutate(outcome = "7d readmission",
                              site = "Intervention",
                              hypothesis = "prepost",
                              pvalue = pval_read7_i)
...
### Pre-slope
```{r}
K <- get_linear_combination_for_preslope(spline_basis_read7, xt_vals)
...
confint_read7_i_pre <- exp(glht_logslopediff_ci$confint)

pval_read7_i_pre <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_read7_i_pre))

results[nrow(results), "outcome"] <- "7d readmission"
results[nrow(results), "site"] <- "Intervention"
results[nrow(results), "hypothesis"] <- "pre"
results[nrow(results), "pvalue"] <- pval_read7_i_pre
...
### Post-slope
```{r}
K <- get_linear_combination_for_postslope(spline_basis_read7, xt_vals)
...
confint_read7_i_post <- exp(glht_logslopediff_ci$confint)

pval_read7_i_post <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_read7_i_post))

results[nrow(results), "outcome"] <- "7d readmission"
results[nrow(results), "site"] <- "Intervention"
results[nrow(results), "hypothesis"] <- "post"
results[nrow(results), "pvalue"] <- pval_read7_i_post

results
```


## 30-day all cause readmission rate, no control
...
broom.mixed::tidy(hf_read30_all_nc_model_glmer_spline,
                  conf.int=TRUE,
                  conf.method=conf.method,
                  exponentiate=TRUE,
                  effects="fixed") %>% 
...
results[nrow(results), "site"] <- "Intervention"
results[nrow(results), "hypothesis"] <- "prepost"
...
### Pre-slope
```{r}
K <- get_linear_combination_for_preslope(spline_basis_read30, xt_vals)
...
confint_read30_i_pre <- exp(glht_logslopediff_ci$confint)

pval_read30_i_pre <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_read30_i_pre))

results[nrow(results), "outcome"] <- "30d readmission"
results[nrow(results), "site"] <- "Intervention"
results[nrow(results), "hypothesis"] <- "pre"
results[nrow(results), "pvalue"] <- pval_read30_i_pre
...
### Post-slope
```{r}
K <- get_linear_combination_for_postslope(spline_basis_read30, xt_vals)
...
confint_read30_i_post <- exp(glht_logslopediff_ci$confint)

pval_read30_i_post <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_read30_i_post))

results[nrow(results), "outcome"] <- "30d readmission"
results[nrow(results), "site"] <- "Intervention"
results[nrow(results), "hypothesis"] <- "post"
results[nrow(results), "pvalue"] <- pval_read30_i_post

results
```


## 90-day all cause readmission rate, no control
...
broom.mixed::tidy(hf_read90_all_nc_model_glmer_spline,
                  conf.int=TRUE,
                  conf.method=conf.method,
                  exponentiate=TRUE,
                  effects="fixed") %>% 
...
### Pre-slope
```{r}
K <- get_linear_combination_for_preslope(spline_basis_read90, xt_vals)
...
confint_read90_i_pre <- exp(glht_logslopediff_ci$confint)

pval_read90_i_pre <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_read90_i_pre))

results[nrow(results), "outcome"] <- "90d readmission"
results[nrow(results), "site"] <- "Intervention"
results[nrow(results), "hypothesis"] <- "pre"
results[nrow(results), "pvalue"] <- pval_read90_i_pre
...
### Post-slope
```{r}
K <- get_linear_combination_for_postslope(spline_basis_read90, xt_vals)
...
confint_read90_i_post <- exp(glht_logslopediff_ci$confint)

pval_read90_i_post <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_read90_i_post))

results[nrow(results), "outcome"] <- "90d readmission"
results[nrow(results), "site"] <- "Intervention"
results[nrow(results), "hypothesis"] <- "post"
results[nrow(results), "pvalue"] <- pval_read90_i_post
...
### Pre-slope
```{r}
K <- get_linear_combination_for_preslope(spline_basis_death, xt_vals)
...
confint_death_i_pre <- exp(glht_logslopediff_ci$confint)

pval_death_i_pre <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_death_i_pre))

results[nrow(results), "outcome"] <- "Mortality"
results[nrow(results), "site"] <- "Intervention"
results[nrow(results), "hypothesis"] <- "pre"
results[nrow(results), "pvalue"] <- pval_death_i_pre
...
### Post-slope
```{r}
K <- get_linear_combination_for_postslope(spline_basis_death, xt_vals)
...
confint_death_i_post <- exp(glht_logslopediff_ci$confint)

pval_death_i_post <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_death_i_post))

results[nrow(results), "outcome"] <- "Mortality"
results[nrow(results), "site"] <- "Intervention"
results[nrow(results), "hypothesis"] <- "post"
results[nrow(results), "pvalue"] <- pval_death_i_post
...
broom.mixed::tidy(hf_los_log_model_lmer_spline,
                  conf.int=TRUE,
                  conf.method=conf.method,
                  exponentiate=TRUE,
                  effects="fixed") %>% 
...
### Pre-slope
```{r}
K <- get_linear_combination_for_preslope(spline_basis_los, xt_vals)
...
confint_los_i_pre <- exp(glht_logslopediff_ci$confint)

pval_los_i_pre <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_los_i_pre))

results[nrow(results), "outcome"] <- "Length of stay"
results[nrow(results), "site"] <- "Intervention"
results[nrow(results), "hypothesis"] <- "pre"
results[nrow(results), "pvalue"] <- pval_los_i_pre
...
### Post-slope
```{r}
K <- get_linear_combination_for_postslope(spline_basis_los, xt_vals)
...
confint_los_i_post <- exp(glht_logslopediff_ci$confint)

pval_los_i_post <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_los_i_post))

results[nrow(results), "outcome"] <- "Length of stay"
results[nrow(results), "site"] <- "Intervention"
results[nrow(results), "hypothesis"] <- "post"
results[nrow(results), "pvalue"] <- pval_los_i_post
...
# Control Site Outcome Analysis

## 7-day all cause readmission rate, control
...
broom.mixed::tidy(hf_read7_all_c_model_glmer_spline,
                  conf.int=TRUE,
                  conf.method=conf.method,
                  exponentiate=TRUE,
                  effects="fixed") %>% 
...
### Pre-slope
```{r}
K <- get_linear_combination_for_preslope(spline_basis_read7c, xt_vals)
...
confint_read7_c_pre <- exp(glht_logslopediff_ci$confint)

pval_read7_c_pre <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_read7_c_pre))

results[nrow(results), "outcome"] <- "7d readmission"
results[nrow(results), "site"] <- "Control"
results[nrow(results), "hypothesis"] <- "pre"
results[nrow(results), "pvalue"] <- pval_read7_c_pre
...
### Post-slope
```{r}
K <- get_linear_combination_for_postslope(spline_basis_read7c, xt_vals)
...
confint_read7_c_post <- exp(glht_logslopediff_ci$confint)

pval_read7_c_post <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_read7_c_post))

results[nrow(results), "outcome"] <- "7d readmission"
results[nrow(results), "site"] <- "Control"
results[nrow(results), "hypothesis"] <- "post"
results[nrow(results), "pvalue"] <- pval_read7_c_post

results
```


## 30-day all cause readmission rate, control
...
broom.mixed::tidy(hf_read30_all_c_model_glmer_spline,
                  conf.int=TRUE,
                  conf.method=conf.method,
                  exponentiate=TRUE,
                  effects="fixed") %>% 
...
### Pre-slope
```{r}
K <- get_linear_combination_for_preslope(spline_basis_read30c, xt_vals)
...
confint_read30_c_pre <- exp(glht_logslopediff_ci$confint)

pval_read30_c_pre <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_read30_c_pre))

results[nrow(results), "outcome"] <- "30d readmission"
results[nrow(results), "site"] <- "Control"
results[nrow(results), "hypothesis"] <- "pre"
results[nrow(results), "pvalue"] <- pval_read30_c_pre
...
### Post-slope
```{r}
K <- get_linear_combination_for_postslope(spline_basis_read30c, xt_vals)
...
confint_read30_c_post <- exp(glht_logslopediff_ci$confint)

pval_read30_c_post <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_read30_c_post))

results[nrow(results), "outcome"] <- "30d readmission"
results[nrow(results), "site"] <- "Control"
results[nrow(results), "hypothesis"] <- "post"
results[nrow(results), "pvalue"] <- pval_read30_c_post
...
## 90-day all cause readmission rate, control
...
broom.mixed::tidy(hf_read90_all_c_model_glmer_spline,
                  conf.int=TRUE,
                  conf.method=conf.method,
                  exponentiate=TRUE,
                  effects="fixed") %>% 
...
### Pre-slope
```{r}
K <- get_linear_combination_for_preslope(spline_basis_read90c, xt_vals)
...
confint_read90_c_pre <- exp(glht_logslopediff_ci$confint)

pval_read90_c_pre <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_read90_c_pre))

results[nrow(results), "outcome"] <- "90d readmission"
results[nrow(results), "site"] <- "Control"
results[nrow(results), "hypothesis"] <- "pre"
results[nrow(results), "pvalue"] <- pval_read90_c_pre
...
### Post-slope
```{r}
K <- get_linear_combination_for_postslope(spline_basis_read90c, xt_vals)
...
confint_read90_c_post <- exp(glht_logslopediff_ci$confint)

pval_read90_c_post <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_read90_c_post))

results[nrow(results), "outcome"] <- "90d readmission"
results[nrow(results), "site"] <- "Control"
results[nrow(results), "hypothesis"] <- "post"
results[nrow(results), "pvalue"] <- pval_read90_c_post
...
### Pre-post slope comparison
```{r}
spline_basis_death_c <- splines2::bSpline(hf_any_data_oc_wm_c$X_t,
                                        knots = c(-6.23428),
                                        degree = 1)
```
...
bsfns <- get_spline_eqns(spline_basis_death_c,
                         x_vals = xt_vals)
...
```
```{r}
K <- get_linear_combination_for_difference_in_log_rr(spline_basis_death_c, xt_vals)
...
### Pre-slope
```{r}
K <- get_linear_combination_for_preslope(spline_basis_death_c, xt_vals)
...
confint_death_c_pre <- exp(glht_logslopediff_ci$confint)

pval_death_c_pre <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_death_c_pre))

results[nrow(results), "outcome"] <- "Mortality"
results[nrow(results), "site"] <- "Control"
results[nrow(results), "hypothesis"] <- "pre"
results[nrow(results), "pvalue"] <- pval_death_c_pre
...
### Post-slope
```{r}
K <- get_linear_combination_for_postslope(spline_basis_death_c, xt_vals)
...
confint_death_c_post <- exp(glht_logslopediff_ci$confint)

pval_death_c_post <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_death_c_post))

results[nrow(results), "outcome"] <- "Mortality"
results[nrow(results), "site"] <- "Control"
results[nrow(results), "hypothesis"] <- "post"
results[nrow(results), "pvalue"] <- pval_death_c_post
...
broom.mixed::tidy(hf_los_log_model_lmer_spline_c,
                  conf.int=TRUE,
                  conf.method=conf.method,
                  exponentiate=TRUE,
                  effects="fixed") %>% 
...
### Pre-post slope comparison
```{r}
spline_basis_los_c <- splines2::bSpline(hf_any_data_oc_c_ll$X_t,
                                        knots = c(-6.23428),
                                        degree = 1)
```
...
bsfns <- get_spline_eqns(spline_basis_los_c,
                         x_vals = xt_vals)
...
```
```{r}
K <- get_linear_combination_for_difference_in_log_rr(spline_basis_los_c, xt_vals)
...
### Pre-slope
```{r}
K <- get_linear_combination_for_preslope(spline_basis_los_c, xt_vals)
...
confint_los_c_pre <- exp(glht_logslopediff_ci$confint)

pval_los_c_pre <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_los_c_pre))

results[nrow(results), "outcome"] <- "Length of stay"
results[nrow(results), "site"] <- "Control"
results[nrow(results), "hypothesis"] <- "pre"
results[nrow(results), "pvalue"] <- pval_los_c_pre
...
### Post-slope
```{r}
K <- get_linear_combination_for_postslope(spline_basis_los_c, xt_vals)
...
confint_los_c_post <- exp(glht_logslopediff_ci$confint)

pval_los_c_post <- summary(glht_logslopediff)$test$pvalues[1]

results <- results %>% bind_rows(as_tibble(confint_los_c_post))

results[nrow(results), "outcome"] <- "Length of stay"
results[nrow(results), "site"] <- "Control"
results[nrow(results), "hypothesis"] <- "post"
results[nrow(results), "pvalue"] <- pval_los_c_post
...
```{r}
results %>%
  dplyr::select(outcome, hypothesis, site, Estimate, lwr, upr, pvalue) %>% 
  knitr::kable()
```
